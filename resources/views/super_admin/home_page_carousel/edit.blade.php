        ...
        <section class="content">
            ...
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.home-page-carousel.update', $homePageCarousel->id) }}" method="POST" id="carouselForm"
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="title" id="title"
                                    class="form-control @error('title') is-invalid @enderror" value="{{ old('title', $homePageCarousel->title) }}"
                                    placeholder="title">
                                @error('image')
                            ...
                            <div class="form-group mb-2">
                                ...
                                @error('image')
                                    <span class="small text-danger">{{ $message }}</span>
                                @enderror
                                <div class="my-2" style="display: @if(empty($homePageCarousel->image)) none @endif);">
                                    <img class="w-25 imgRenderContainer" src="{{ public_asset($homePageCarousel->image) }}" alt="{{ $homePageCarousel->title }}">
                                </div>
                            </div>
