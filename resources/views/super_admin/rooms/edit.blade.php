    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.room.type.update', $room->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="0" id="season_rate" name="season_rate"
                                    class="form-control" value="{{ old('season_rate', $room->season_rate) }}"
                            ...
                            <div class="form-group">
                                ...
                                @if($room->image)
                                    <img id="imagePreview" src="{{ public_asset($room->image) }}" alt="Preview" style="max-width: 200px; max-height: 200px;" class="my-2">
                                @else
                                    <img id="imagePreview" src="{{ public_asset($room->image) }}" alt="Preview" style="display: none; max-width: 200px; max-height: 200px;" class="my-2">
                                @endif
                                @error('image')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="slider-container">
                                        <input type="checkbox" @if($room->status == 1) checked @endif name="status" value="1" id="checkbox"
                                            class="checkbox">
